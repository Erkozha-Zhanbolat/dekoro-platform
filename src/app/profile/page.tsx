    ...
    <div className="mx-auto max-w-6xl px-6 py-16">
      ...
      <div className="mt-6 max-w-xl rounded-md border border-neutral-200 p-6">
        <dl className="flex flex-col gap-4">
          ...
          <ProfileField label="Компания" value={metadata.company_name ?? "—"} />
          <ProfileField label="БИН" value={metadata.bin ?? "—"} />
          <ProfileField label="Контактное лицо" value={metadata.contact_person ?? "—"} />
          <ProfileField label="Телефон" value={metadata.phone ?? "—"} />
        </dl>
      </div>
