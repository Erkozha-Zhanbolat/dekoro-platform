    ...
    >
      <Page size={PDF_PAGE_SIZE} orientation="portrait" style={styles.page}>
        ...
        <View style={[styles.section, styles.row]}>
          ...
          <View style={styles.col}>
            ...
            <Text style={styles.line}>
              {str(buyer.legal_name ?? buyer.display_name)}
            </Text>
            <Text style={styles.line}>ИИН/БИН {str(buyer.iin_bin)}</Text>
            <Text style={styles.line}>{str(buyer.address)}</Text>
            <Text style={styles.line}>тел. {str(buyer.phone)}</Text>
            <Text style={styles.line}>{str(buyer.contact_person)}</Text>
          </View>
        </View>
        ...
        <View style={styles.bank} wrap={false}>
          ...
          <Text style={styles.line}>Банк: {str(supplier.bank_name)}</Text>
